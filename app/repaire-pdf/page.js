    ...
    return ( 
        <>
            ...
            <nav className="text-center">
                <Link href="/" className="mx-2">Home</Link> | <Link href="#" className="mx-2">Repaire Pdf</Link>
            </nav>
            <div className="container-fluid container-custom">
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-12">
                        <h5>Repair PDF file</h5>

                        <div className="description-box">
                            <p style={{ background: "#DED4FC" }}>We will try to repair your PDFs. <br />You can get a different file format on <br /> download if we detect that format in your file.</p>
                        </div>
                        ...
                        <button className={classNames(style.btn, style.btnConvert)}>Repaire Pdf</button>
                    </div>
                    </form>
                </div>
            </div>
