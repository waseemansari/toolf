...
const PdfToExcel = () => {
    ...
    const onSubmit = async (values, e) => {
        ...
        formData.append('type', "pdf_to_excel");
        ...
        try {
            ...
            const newName = originalName.replace(/\.pdf$/i, "") + ".xlsx";
            link.href = url;
    ...
    return (
        <>
            ...
            <nav className="text-center">
                <Link href="/" className="mx-2">Home</Link> | <Link href="#" className="mx-2">Pdf To Excel</Link>
            </nav>
                ...
                <div className="row">
                    {/* <!-- Left Side - PDF Placeholder --> */}
                        ...
                        <div className="col-lg-6 col-md-12">
                            <h5><strong>PDF To Excel</strong></h5>
                            ...
                            <div className={style.optionBox}>
                                <div className={style.optionContent}>
                                    ...
                                    <p>Convert PDFs with selectable text into editable Excel files.</p>
                                </div>
                                <input type="checkbox" />
                            </div>
                            <button className={classNames(style.btn, style.btnConvert)} >Convert To Excel</button>
                        </div>
