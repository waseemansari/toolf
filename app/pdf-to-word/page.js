    ...
    return (
        <>
            ...
            <nav className="text-center">
                <Link href="/" className="mx-2">Home</Link> | <Link href="#" className="mx-2">Pdf To Word</Link>
            </nav> 
                ...
                <div className="row">
                    {/* <!-- Left Side - PDF Placeholder --> */}
                        ...
                        <div className="col-lg-6 col-md-12">
                            <h5><strong>PDF To Word</strong></h5>
                            ...
                            <button className={classNames(style.btn, style.btnConvert)} >Convert To Word</button>
                        </div>
