...
const ProtectPDF = () => {
    ...
    const onSubmit = async  (values, e) => {
        ...
        formData.append('type', "protect-pdf");
    ...
    return (
        <>
            ...
            <nav className="text-center">
                <Link href="/" className="mx-2">Home</Link> | <Link href="#" className="mx-2">Protect PDF</Link>
            </nav>
                    ...
                    <div className="col-lg-6 col-md-12">
                        <div className="password-protect-section">
                            ...
                            <img src="assests/Group 89.png" alt="Upload Image" />
                                ...
                                <p className="form-text">Set a password to protect your PDF file</p>
                                <button type="submit" className="btn btn-primary btn-block">Protect PDF</button>
                            </form>
                        </div>
                    </div>
                </div>
