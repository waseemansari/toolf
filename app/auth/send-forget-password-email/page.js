...
import { useSendForgetEmailMutation } from "../../../Services/api";
...
const Login = () => {
    ...
    const [SendForgetEmail, isLoading] = useSendForgetEmailMutation();
    const {
        register,
        handleSubmit,
        formState: { errors },
    ...
    const onSubmit = (values) => {
        router.push(`/auth/change-password/${encodeURIComponent(values.email)}`);
         
        SendForgetEmail({ data: values })
            .unwrap()
            .then((payload) => {
                if (payload.statusCode == 200) {
                  
                    router.push('changed-password',values.email);
                ...
                <div className="row justify-content-center align-items-start">
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 d-flex justify-content-center">
                        <div className="card text-center shadow-sm p-4 login-box">
                            ...
                            <p>If You Have Any Question Concerning <br /> Our Services Or  Hesitate <br /> To Contact Us.</p>
