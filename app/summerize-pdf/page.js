...
const SummerizePdf = () => {
    ...
    const onSubmit = async (values, e) => {
        ...
        formData.append('type', "summarize_pdf");
        ...
        try {
            ...
            const newName = originalName.replace(/\.pdf$/i, "") + ".txt";
        ...
        <>
            ...
            <div className="container my-5 split-pdf-section">
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <h2 className="text-center mb-5">Summerize PDF</h2>
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-12 range-section">
                            ...
                            {/* <!-- Info Text --> */}
                            <div className="range-text bg-light p-2 mt-2 text-center">This PDF will be Summerize into files of 2 pages.</div>
                            ...
                            {loading 
                             ...
                             :
                                <button className="btn btn-warning w-100 mt-3 " >Summerize PDF</button>
                            }
                        </div>
                    </div>
                </form>
