    ...
    return (
        <>
            ...
            <nav className="text-center">
                <Link href="/" className="mx-2">Home</Link> | <Link href="#" className="mx-2">Edit Pdf</Link>
            </nav>
                        ...
                        <div className="col-lg-6 col-md-12">
                            ...
                            <div className={style.optionBox}>
                                <div className={style.optionContent}>
                                    ...
                                    <p>Convert PDFs with selectable text into editable  Pdf files.</p>
                                </div>
                                <input type="checkbox" />
                            </div>
                            <button className={classNames(style.btn, style.btnConvert)} >Edit Pdf</button>
                        </div>
