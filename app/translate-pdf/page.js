...
const TranslatPdf = () => {
    ...
    const onSubmit = async (values, e) => {
        ...
        formData.append('type', "translate_pdf");
        ...
        <>
            ...
            <div className="container my-5 split-pdf-section">
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <h2 className="text-center mb-5">Translate PDF</h2>
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-12 range-section">
                            ...
                            {loading 
                             ...
                             :
                                <button className="btn btn-warning w-100 mt-3 " >Translate PDF</button>
                            }
                        </div>
                    </div>
                </form>
